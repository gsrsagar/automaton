...
export const DEFAULT_ROUTING_MATRIX: RoutingMatrix = {
  high: {
    agent_turn: { candidates: ["qwen2.5:0.5b", "qwen2.5:3b", "qwen2.5:7b"], maxTokens: 8192, ceilingCents: -1 },
    heartbeat_triage: { candidates: ["gemma3:1b", "qwen2.5:0.5b"], maxTokens: 2048, ceilingCents: 5 },
    safety_check: { candidates: ["qwen2.5:0.5b", "gemma3:1b"], maxTokens: 4096, ceilingCents: 20 },
    summarization: { candidates: ["gemma3:1b", "qwen2.5:0.5b"], maxTokens: 4096, ceilingCents: 15 },
    planning: { candidates: ["qwen2.5:0.5b", "gemma3:1b"], maxTokens: 8192, ceilingCents: -1 },
  },
  normal: {
    agent_turn: { candidates: ["qwen2.5:0.5b", "qwen2.5:3b", "qwen2.5:7b"], maxTokens: 4096, ceilingCents: -1 },
    heartbeat_triage: { candidates: ["gemma3:1b", "qwen2.5:0.5b"], maxTokens: 2048, ceilingCents: 5 },
    safety_check: { candidates: ["qwen2.5:0.5b", "gemma3:1b"], maxTokens: 4096, ceilingCents: 10 },
    summarization: { candidates: ["gemma3:1b", "qwen2.5:0.5b"], maxTokens: 4096, ceilingCents: 10 },
    planning: { candidates: ["qwen2.5:0.5b", "gemma3:1b"], maxTokens: 4096, ceilingCents: -1 },
  },
  low_compute: {
  ...
  critical: {
    agent_turn: { candidates: ["qwen2.5:0.5b"], maxTokens: 2048, ceilingCents: 3 },
    heartbeat_triage: { candidates: ["smollm2:135m"], maxTokens: 512, ceilingCents: 1 },
    safety_check: { candidates: ["qwen2.5:0.5b"], maxTokens: 1024, ceilingCents: 2 },
